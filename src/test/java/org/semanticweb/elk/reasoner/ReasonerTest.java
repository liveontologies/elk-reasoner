...
public class ReasonerTest extends TestCase {
	...
	public void testExistentials() {
		...
		assertTrue("A contains D", reasoner.saturator.getContext(A).derivedConcepts.contains(D));
	}
	...
	public void testConjunctions() {
		...
		reasoner.saturator.saturate(A);
		assertTrue("A contains A", context.derivedConcepts.contains(A));
		assertTrue("A contains B", context.derivedConcepts.contains(B));
		assertTrue("A contains C", context.derivedConcepts.contains(C));
		assertTrue("A contains I", context.derivedConcepts.contains(I));
