...
public class RuleStatistics extends
	 ...
	 */
	int countDatatypeExpressionDecompositionRule;

	/**
	 * the time spent within the decomposition rule of
	 * {@link IndexedDatatypeExpression}
	 */
	long timeDatatypeExpressionDecompositionRule;
	 ...
	 *         {@link IndexedDatatypeExpression}
	 */
	public long getDatatypeExpressionDecompositionRuleCount() {
		return countDatatypeExpressionDecompositionRule;
	}
	 ...
	 *         {@link IndexedDatatypeExpression}
	 */
	public long getDatatypeExpressionDecompositionRuleTime() {
		return timeDatatypeExpressionDecompositionRule;
	}
	...
	public void reset() {
		super.reset();
		countDatatypeExpressionDecompositionRule = 0;
		timeDatatypeExpressionDecompositionRule = 0;
	...
	public synchronized void merge(RuleStatistics stats) {
		super.merge(stats);
		this.countDatatypeExpressionDecompositionRule += stats.countDatatypeExpressionDecompositionRule;
		this.timeDatatypeExpressionDecompositionRule += stats.timeDatatypeExpressionDecompositionRule;
