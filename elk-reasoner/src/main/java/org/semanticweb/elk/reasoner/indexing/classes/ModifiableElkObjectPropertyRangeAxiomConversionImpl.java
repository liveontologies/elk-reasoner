 ...
 */
class ModifiableElkObjectPropertyRangeAxiomConversionImpl
		extends
			ModifiableIndexedObjectPropertyRangeAxiomInferenceImpl<ElkObjectPropertyRangeAxiom>
		implements
			ModifiableElkObjectPropertyRangeAxiomConversion {
