 ...
 */
class ModifiableElkDisjointClassesAxiomNaryConversionImpl
		extends
			ModifiableIndexedDisjointClassesAxiomInferenceImpl<ElkDisjointClassesAxiom>
		implements
			ModifiableElkDisjointClassesAxiomNaryConversion {
