...
import org.semanticweb.elk.reasoner.reduction.TransitiveReductionShared;

/**
 * The objects and methods that are shared by multiple workers of the
 * {@link TaxonomyComputationEngine}
 * 
 * @author "Yevgeny Kazakov"
 * 
 */
public class TaxonomyComputationShared {
	 ...
	 * construction
	 */
	protected final TransitiveReductionShared<IndexedClassEntity, TransitiveReductionJob<IndexedClassEntity>> transitiveReductionShared;
	/**
	 ...
	 *            results in
	 */
	public TaxonomyComputationShared(OntologyIndex ontologyIndex,
			IndividualClassTaxonomy partialTaxonomy) {
		this.taxonomy = partialTaxonomy;
		this.transitiveReductionShared = new TransitiveReductionShared<IndexedClassEntity, TransitiveReductionJob<IndexedClassEntity>>(
