 ...
 *
 */
public class IndexedPropertyComposition extends IndexedPropertyExpression 
		implements Iterable<IndexedPropertyComposition> {
	/**
	 * The SubObjectPropertyOfAxiom that is represented by this object. Null
	 * if this object corresponds to an auxiliary inclusion created during
	 * binarization.
	 */
	protected final ElkSubObjectPropertyOfAxiom representative;
	
	protected final IndexedObjectProperty leftProperty;
	protected final IndexedPropertyExpression rightProperty;
	protected final IndexedPropertyExpression superProperty;
	 ...
	 * @param rightProperty
	 */
	protected IndexedPropertyComposition(
			IndexedObjectProperty leftProperty,
			IndexedPropertyExpression rightProperty) {
	...
	/**
	 * @return The left component of this (binary) complex property
	 * inclusion axiom.
	 */
	...
	/**
	 * @return The right component of this (binary) complex property
	 * inclusion axiom.
	 */
	public IndexedPropertyExpression getRightProperty() {
	...
	/**
	 * Iterator through all auxiliary intermediate property compositions
	 * of this object.
	 */
	public Iterator<IndexedPropertyComposition> iterator() {
		return new Iterator<IndexedPropertyComposition>() {
		
			private IndexedPropertyExpression i = IndexedPropertyComposition.this;
