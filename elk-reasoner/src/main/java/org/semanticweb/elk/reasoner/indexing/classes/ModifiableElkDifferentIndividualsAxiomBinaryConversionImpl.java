 ...
 */
class ModifiableElkDifferentIndividualsAxiomBinaryConversionImpl
		extends
			ModifiableIndexedSubClassOfAxiomInferenceImpl<ElkDifferentIndividualsAxiom>
		implements
			ModifiableElkDifferentIndividualsAxiomBinaryConversion {
