 ...
 */
public class ArbitraryIntegerInterval extends AbstractIntegerInterval {

	public ArbitraryIntegerInterval(Number lower, boolean lowerInclusive, Number upper, boolean upperInclusive) {
