 ...
 */
public class LeftReflexiveSubPropertyChainInference extends
		ReflexiveSubPropertyChainInference<IndexedPropertyChain> {

	public LeftReflexiveSubPropertyChainInference(
			IndexedComplexPropertyChain sub, IndexedPropertyChain sup) {
		super(sub, sub.getSuffixChain(), sup);
	}

	@Override
	public ReflexivePropertyChainImpl<IndexedObjectProperty> getReflexivePremise() {
		return new ReflexivePropertyChainImpl<IndexedObjectProperty>(
				chain.getFirstProperty());
	}
