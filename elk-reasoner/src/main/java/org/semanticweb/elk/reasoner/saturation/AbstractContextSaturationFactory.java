 ...
 * . To every {@link AbstractContextSaturationFactory} it is possible to attach
 ...
 * 
 */
public abstract class AbstractContextSaturationFactory<J extends SaturationJob<? extends IndexedClassExpression>, I extends RuleApplicationInput>
		implements
		InputProcessorFactory<J, AbstractContextSaturationFactory<J, I>.Engine> {

	// logger for this class
	private static final Logger LOGGER_ = LoggerFactory
			.getLogger(AbstractContextSaturationFactory.class);
	 ...
	 * saturation rules.
	 */
	private final RuleApplicationFactory<?, I> ruleApplicationFactory_;
	/**
	...
	/**
	 * Creates a new {@link AbstractContextSaturationFactory} using the given
	 ...
	 */
	public AbstractContextSaturationFactory(
			RuleApplicationFactory<?, I> ruleAppFactory, int maxWorkers,
	...
	protected abstract I createRuleApplicationInput(J saturationJob);
	
	protected abstract boolean isJobFinished(J saturationJob, Context jobContext);
	...
	public class Engine implements InputProcessor<J> {
		...
		private final InputProcessor<I> ruleApplicationEngine_ = ruleApplicationFactory_
		...
		public void process() throws InterruptedException {
			...
			for (;;) {
				...
				if (isJobFinished(nextJob, rootContext)/*rootContext != null && rootContext.isInitialized()
				...
				try {
					...
					ruleApplicationEngine_.submit(createRuleApplicationInput(nextJob));
					ruleApplicationEngine_.process();
