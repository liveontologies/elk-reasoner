...
public interface ContextPremises {
	...
	/**
	 * @param axiom
	 *            the {@link IndexedDisjointClassesAxiom} to be checked for
	 *            causing inconsistency in this {@link ContextPremises}
	 * 
	 * @return {@code true} if the given {@link IndexedDisjointClassesAxiom}
	 *         makes this {@link ContextPremises} inconsistent, that is, this
	 *         context contains at least two different {@link DisjointSubsumer}s
	 *         for this {@link IndexedDisjointClassesAxiom}
	 */
	/*
