...
class StructuralIndexedObjectPropertyEntryImpl extends
		ModifiableIndexedPropertyChainImpl<StructuralIndexedObjectPropertyEntryImpl, StructuralIndexedObjectPropertyEntry<?>>
		implements
		StructuralIndexedObjectPropertyEntry<StructuralIndexedObjectPropertyEntryImpl> {
