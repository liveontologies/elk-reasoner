 ...
 * {@link IndexedAxiom}s to be used in {@link KeyEntryHashSet}.
 * 
 ...
 *            entry
 */
public abstract class IndexedAxiomEntry<T, K extends IndexedAxiom> extends
		IndexedObjectEntry<T, K> {

	IndexedAxiomEntry(K representative) {
