...
public class ClassTaxonomyEngine extends AbstractJobManager<IndexedClass> {
	 ...
	 * class
	 */
	protected final TransitiveReductionEngineForClassTaxonomy transitiveReductionEngine;

	public ClassTaxonomyEngine(OntologyIndex ontologyIndex) {
		this.taxonomy = new ConcurrentClassTaxonomy();
		this.transitiveReductionEngine = new TransitiveReductionEngineForClassTaxonomy(
				ontologyIndex, this.taxonomy);
	}
