 ...
 */
public class NonNegativeIntegerInterval extends AbstractIntegerInterval {

	public NonNegativeIntegerInterval(Number lower, boolean lowerInclusive, Number upper, boolean upperInclusive) {
