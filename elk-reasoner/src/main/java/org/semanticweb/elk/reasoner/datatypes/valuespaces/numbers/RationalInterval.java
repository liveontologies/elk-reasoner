 ...
 */
public class RationalInterval extends NumericInterval<RationalDatatype> {

	public RationalInterval(Number lower, boolean lowerInclusive, Number upper, boolean upperInclusive) {
