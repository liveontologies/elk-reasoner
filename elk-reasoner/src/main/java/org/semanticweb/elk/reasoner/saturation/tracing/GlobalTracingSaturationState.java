...
/**
 * Used when performing eager tracing from scratch.
 * 
 * @author Pavel Klinov
 *
 * pavel.klinov@uni-ulm.de
 */
public class GlobalTracingSaturationState implements SaturationState {
	 ...
	 * 
	 */
	public GlobalTracingSaturationState(SaturationState state) {
