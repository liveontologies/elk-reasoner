...
public class SaturationStateFactory {
	...
	public static TracingSaturationState createTracingSaturationState(OntologyIndex ontologyIndex) {
		return new TracingSaturationState(createSaturationState(ontologyIndex));
	}
}
