...
public class ReflexiveToldSubObjectProperty extends
		AbstractReflexivePropertyChainInference<IndexedObjectProperty> {
	...
	public ReflexivePropertyChainImpl<?> getSubProperty() {
		return new ReflexivePropertyChainImpl<IndexedPropertyChain>(subChain_);
	}
