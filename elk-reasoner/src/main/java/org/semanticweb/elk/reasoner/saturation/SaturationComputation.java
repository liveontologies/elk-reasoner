 ...
 *
 */
public class SaturationComputation extends ConcurrentComputationManager<SaturatedClassExpression> {

	protected final static Logger logger = Logger
			.getLogger(SaturationComputation.class);

	public SaturationComputation(ExecutorService executor, int workerNo) {
		super(executor, workerNo, 512);
	}
