...
public class DerivedIntersectionInconsistencyEntailsDisjointClassesAxiomImpl
		extends
		AbstractAxiomEntailmentInference<ElkDisjointClassesAxiom, DisjointClassesAxiomEntailment>
		implements DerivedIntersectionInconsistencyEntailsDisjointClassesAxiom {

	private final List<? extends SubClassOfAxiomEntailment> premises_;

	public DerivedIntersectionInconsistencyEntailsDisjointClassesAxiomImpl(
