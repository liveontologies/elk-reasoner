...
public abstract class InternalNodeFactory<
		...
		> implements NodeFactory<T, CreatedN> {

	protected final AbstractDistinctBottomTaxonomy<T, N> taxonomy_;
	
	public InternalNodeFactory(final AbstractDistinctBottomTaxonomy<T, N> taxonomy) {
