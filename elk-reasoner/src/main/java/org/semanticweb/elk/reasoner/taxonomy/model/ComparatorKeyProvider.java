...
/**
 * A {@link KeyProvider} that provides also a {@link Comparator} for objects of type <code>T</code>.
 * 
 * @author Peter Skocovsky
 *
 * @param <T> The type of the objects for which the comparator should be provided.
 */
