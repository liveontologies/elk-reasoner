...
/**
 * Implements an equality view for instances of {@link IndexedSubObjectPropertyOfAxiom}
 * 
 * @author Pavel Klinov
 * 
 * @param <T> 
...
public class IndexedSubObjectPropertyOfAxiomEntry<T, K extends IndexedSubObjectPropertyOfAxiom<?>>
	...
	public int computeHashCode() {
		return combinedHashCode(IndexedSubObjectPropertyOfAxiomEntry.class,
				this.key.getSubProperty(), this.key.getSuperProperty());
	}
	...
	public boolean equals(Object other) {
		...
		if (other instanceof IndexedSubObjectPropertyOfAxiomEntry<?, ?>) {
			...
			return this.key.getSubProperty().equals(otherEntry.key.getSubProperty())
