...
/**
 * A visitor pattern for {@link ClassConclusion}s together with additional input and
 * output parameters
 * 
 * @author Pavel Klinov
 * 
 ...
 */
public interface ClassConclusionVisitor<I, O> extends SubConclusionVisitor<I, O> {
