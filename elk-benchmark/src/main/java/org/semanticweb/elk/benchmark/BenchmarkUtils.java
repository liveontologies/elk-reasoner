...
public class BenchmarkUtils {
	...
	/*
	 * Checks that all System properties are set.
	 * We use System properties (other than cmd args) because they're
	 * easier to pass parameters into maven tests (via Surefire or Failsafe plugins)
	 */
	...
	public static void checkIfSet(String propName, Map<String, String> propMap) {
		...
		if (propValue == null) {
			System.err.println(propName + " property is not set, re-run with " + "-D" + propName + "=<value>?");
		}
		else {
