...
/**
 * A task to compute the realization of the ontology, i.e., direct and indirect types for all named individuals.
 * 
 * @author Pavel Klinov
 * 
 *         pavel.klinov@uni-ulm.de
 */
public class RealizationTask implements Task {
	...
	public RealizationTask(String[] args) {
	...
	public void run() throws TaskException {
		try {
			InstanceTaxonomy<ElkClass, ElkNamedIndividual> t = reasoner_.getInstanceTaxonomy();
