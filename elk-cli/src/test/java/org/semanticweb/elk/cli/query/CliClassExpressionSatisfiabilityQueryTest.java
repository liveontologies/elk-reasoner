...
public class CliClassExpressionSatisfiabilityQueryTest extends
	...
	public static Configuration getConfig()
		...
		return ConfigurationUtils.loadFileBasedTestConfiguration(
				...
				"expected",
				new MultiManifestCreator<ClassQueryTestInput<ElkClassExpression>, SatisfiabilityTestOutput, SatisfiabilityTestOutput>() {

					@Override
					public Collection<? extends TestManifestWithOutput<ClassQueryTestInput<ElkClassExpression>, SatisfiabilityTestOutput, SatisfiabilityTestOutput>> createManifests(
