...
/**
 * Wrapper used for indicating that this IndexedClassExpression has been derived
 * by a composition rule. Decomposition rules need not be applied to such
 * expression.
 * 
 * 
 ...
 * 
 */
class DecomposedClassExpression implements Queueable {
