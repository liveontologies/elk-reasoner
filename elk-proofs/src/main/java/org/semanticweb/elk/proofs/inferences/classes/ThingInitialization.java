...
public class ThingInitialization extends AbstractClassInference {
	...
	public ThingInitialization(ElkClassExpression expr, ElkObjectFactory factory, DerivedExpressionFactory exprFactory) {
		super(factory.getSubClassOfAxiom(expr, PredefinedElkClass.OWL_THING), exprFactory);
	}
