...
public class OwlApiClassExpressionInstancesQueryTest extends
	...
	public static Configuration getConfig()
		...
		return ConfigurationUtils.loadFileBasedTestConfiguration(
				...
				"expected",
				new MultiManifestCreator<ClassQueryTestInput<OWLClassExpression>, RelatedEntitiesTestOutput<OWLNamedIndividual>, RelatedEntitiesTestOutput<OWLNamedIndividual>>() {

					@Override
					public Collection<? extends TestManifestWithOutput<ClassQueryTestInput<OWLClassExpression>, RelatedEntitiesTestOutput<OWLNamedIndividual>, RelatedEntitiesTestOutput<OWLNamedIndividual>>> createManifests(
