...
import org.semanticweb.elk.alc.saturation.conclusions.interfaces.Subsumer;
...
public class NegatedSubsumerImpl extends AbstractLocalDeterministicConclusion
	...
	public NegatedSubsumerImpl(IndexedClassExpression negatedExpression) {
		if (negatedExpression == null)
			throw new NullPointerException(NegatedSubsumer.NAME
					+ " cannot be null!");
		this.negatedExpression_ = negatedExpression;
	}

	@Override
	public IndexedClassExpression getNegatedExpression() {
		return negatedExpression_;
	}

	@Override
	public String toString() {
		return NegatedSubsumer.NAME + "(" + negatedExpression_.toString() + ")";
	}
