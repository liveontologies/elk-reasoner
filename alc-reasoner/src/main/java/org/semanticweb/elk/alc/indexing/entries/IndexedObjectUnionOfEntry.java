...
public class IndexedObjectUnionOfEntry<T, K extends IndexedObjectUnionOf>
	...
	public int computeHashCode() {
		return combinedHashCode(IndexedObjectUnionOfEntry.class,
				this.key.getFirstDisjunct(), this.key.getSecondDisjunct());
	}
	...
	public boolean equals(Object other) {
		...
		if (other instanceof IndexedObjectUnionOfEntry<?, ?>) {
			...
			return this.key.getFirstDisjunct().equals(
					otherView.key.getFirstDisjunct())
					&& this.key.getSecondDisjunct().equals(
							otherView.key.getSecondDisjunct());
		}
		return false;
	}
