...
public class ConjectureNonSubsumerImpl extends AbstractPossibleSubsumer
		implements ConjectureNonSubsumer {

	public ConjectureNonSubsumerImpl(IndexedClassExpression subsumer) {
		super(subsumer);
	}
	...
	public String toString() {
		return "Conjecture Non-" + super.toString();
	}
