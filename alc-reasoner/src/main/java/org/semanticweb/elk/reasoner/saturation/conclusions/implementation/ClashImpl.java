...
/**
 * An implementation of {@link Clash}
 * 
 * @author Pavel Klinov
 * 
 ...
 */
public class ClashImpl extends AbstractConclusion implements Clash {
	 ...
	 */
	private static ClashImpl INSTANCE_ = new ClashImpl();

	public static ClashImpl getInstance() {
		return INSTANCE_;
	}
