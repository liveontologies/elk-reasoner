...
public class PropagatedComposedSubsumerImpl extends AbstractSubsumer implements
		PropagatedComposedSubsumer {

	public PropagatedComposedSubsumerImpl(IndexedObjectSomeValuesFrom subsumer) {
		super(subsumer);
	}

	@Override
	public IndexedObjectSomeValuesFrom getExpression() {
		return (IndexedObjectSomeValuesFrom) super.getExpression();
	}

	@Override
	public String toString() {
		return "PropagatedComposed" + super.toString();
	}
