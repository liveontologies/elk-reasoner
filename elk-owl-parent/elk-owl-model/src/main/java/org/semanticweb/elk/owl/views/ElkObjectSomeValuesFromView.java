...
/**
 * Implements a view for instances of {@link ElkObjectSomeValuesFrom}
 * 
...
public class ElkObjectSomeValuesFromView<T extends ElkObjectSomeValuesFrom>
		extends
		ElkBinaryObjectView<T, ElkObjectPropertyExpression, ElkClassExpression>
		implements ElkObjectSomeValuesFrom {

	/**
	 * Constructing {@link ElkObjectSomeValuesFromView} from
	 * {@link ElkObjectSomeValuesFrom} using a sub-object viewer
	 * 
	 * @param refElkObjectSomeValuesFrom
	 ...
	 */
	public ElkObjectSomeValuesFromView(T refElkObjectSomeValuesFrom,
