...
public class PredefinedElkIris {
	...
	OWL_BACKWARD_COMPATIBLE_WITH = new ElkFullIri(PredefinedElkPrefix.OWL,
			...
			OWL_BOTTOM_DATA_PROPERTY = new ElkFullIri(
			...
			RDFS_SEE_ALSO = new ElkFullIri(PredefinedElkPrefix.RDFS,
					"seeAlso"),//
			...
			XSD_DATE_TIME = new ElkFullIri(PredefinedElkPrefix.XSD,
					"dateTime"),//
			...
			XSD_NON_NEGATIVE_INTEGER = new ElkFullIri(
					PredefinedElkPrefix.XSD, "nonNegativeInteger"),//
			XSD_NON_POSITIVE_INTEGER = new ElkFullIri(
					PredefinedElkPrefix.XSD, "nonPositiveInteger"),//
