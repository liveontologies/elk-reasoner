 ...
 */
public class ElkDataUnionOfView<T extends ElkDataUnionOf> extends
		ElkNaryObjectView<T, ElkDataRange> implements ElkDataUnionOf {

	/**
	 * Constructing {@link ElkDataUnionOfView} from {@link ElkDataUnionOf} using
	 * a viewer
	 * 
	 * @param refElkDataUnionOf
	 ...
	 */
	public ElkDataUnionOfView(T refElkDataUnionOf,
			ElkObjectViewer subObjectViewer) {
		super(refElkDataUnionOf, subObjectViewer);
	}
