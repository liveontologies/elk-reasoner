...
/**
 * Implements a view for instances of {@link ElkObjectPropertyRangeAxiom}
 * 
...
public class ElkObjectPropertyRangeAxiomView<T extends ElkObjectPropertyRangeAxiom>
		extends
		ElkBinaryObjectView<T, ElkObjectPropertyExpression, ElkClassExpression>
		implements ElkObjectPropertyRangeAxiom {

	/**
	 * Constructing {@link ElkObjectPropertyRangeAxiomView} from
	 * {@link ElkObjectPropertyRangeAxiom} using a sub-object viewer
	 * 
	 * @param refElkObjectPropertyRangeAxiom
	 ...
	 */
	public ElkObjectPropertyRangeAxiomView(T refElkObjectPropertyRangeAxiom,
			ElkObjectViewer subObjectViewer) {
		super(refElkObjectPropertyRangeAxiom, subObjectViewer);
	}
