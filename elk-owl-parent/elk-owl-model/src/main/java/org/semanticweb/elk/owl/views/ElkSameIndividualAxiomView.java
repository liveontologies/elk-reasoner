...
/**
 * Implements a view for instances of {@link ElkSameIndividualAxiom}
 * 
...
public class ElkSameIndividualAxiomView<T extends ElkSameIndividualAxiom>
		extends ElkNaryObjectView<T, ElkIndividual> implements
		ElkSameIndividualAxiom {

	/**
	 * Constructing {@link ElkSameIndividualAxiomView} from
	 * {@link ElkSameIndividualAxiom} using a viewer
	 * 
	 * @param refElkSameIndividualAxiom
	 ...
	 */
	public ElkSameIndividualAxiomView(T refElkSameIndividualAxiom,
			ElkObjectViewer subObjectViewer) {
		super(refElkSameIndividualAxiom, subObjectViewer);
	}
