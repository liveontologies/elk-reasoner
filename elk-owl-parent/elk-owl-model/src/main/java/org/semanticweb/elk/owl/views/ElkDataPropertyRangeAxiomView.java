...
/**
 * Implements a view for instances of {@link ElkDataPropertyRangeAxiom}
 * 
...
public class ElkDataPropertyRangeAxiomView<T extends ElkDataPropertyRangeAxiom>
		extends ElkBinaryObjectView<T, ElkDataPropertyExpression, ElkDataRange>
		implements ElkDataPropertyRangeAxiom {

	/**
	 * Constructing {@link ElkDataPropertyRangeAxiomView} from
	 * {@link ElkDataPropertyRangeAxiom} using a sub-object viewer
	 * 
	 * @param refElkDataPropertyRangeAxiom
	 ...
	 */
	public ElkDataPropertyRangeAxiomView(T refElkDataPropertyRangeAxiom,
			ElkObjectViewer subObjectViewer) {
		super(refElkDataPropertyRangeAxiom, subObjectViewer);
	}
