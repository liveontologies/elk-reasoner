...
/**
 * Implements a view for instances of {@link ElkEquivalentDataPropertiesAxiom}
 * 
...
public class ElkEquivalentDataPropertiesAxiomView<T extends ElkEquivalentDataPropertiesAxiom>
		extends ElkNaryObjectView<T, ElkDataPropertyExpression> implements
		ElkEquivalentDataPropertiesAxiom {

	/**
	 * Constructing {@link ElkEquivalentDataPropertiesAxiomView} from
	 * {@link ElkEquivalentDataPropertiesAxiom} using a viewer
	 * 
	 * @param refElkEquivalentDataPropertiesAxiom
	 ...
	 */
	public ElkEquivalentDataPropertiesAxiomView(
			T refElkEquivalentDataPropertiesAxiom,
			ElkObjectViewer subObjectViewer) {
		super(refElkEquivalentDataPropertiesAxiom, subObjectViewer);
	}
