 ...
 * http://cojen.sourceforge.net/xref/org/cojen/util/WeakCanonicalSet.html
 * 
 * @author Brian S O'Neill
 */
public class WeakCanonicalSet extends AbstractSet<ElkObject> implements
		ElkObjectManager {
	private Entry[] table;
	private int count;
	 ...
	 */
	public synchronized ElkObject getCanonicalElkObject(ElkObject obj) {
		...
		for (Entry e = tab[index], prev = null; e != null; e = e.next) {
			...
			if (iobj == null) {
				...
				this.count--;
			} else if (e.hash == hash && obj.getClass() == iobj.getClass()
					&& equals(obj, iobj)) {
