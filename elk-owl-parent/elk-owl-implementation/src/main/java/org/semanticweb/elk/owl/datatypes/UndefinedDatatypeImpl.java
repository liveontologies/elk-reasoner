 ...
 */
public class UndefinedDatatypeImpl extends ElkDatatypeImpl implements UndefinedDatatype {

	public UndefinedDatatypeImpl(ElkIri iri) {
		super(iri);
	}
	...
	public boolean isCompatibleWith(ElkDatatype datatype) {
		return this.iri.equals(datatype.getIri());
	}
}
