 ...
 */
public class ElkNcNameLiteralImpl extends ElkNameLiteralImpl implements
		ElkNameLiteral {

	
	public ElkNcNameLiteralImpl(String lexicalForm) {
		super(lexicalForm);
	}
	...
	@Override
	public NcNameDatatype getDatatype() {
		return ElkDatatypeMap.XSD_NCNAME;
	}
