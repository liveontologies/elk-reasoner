 ...
 */
public class ElkDateTimeLiteralImpl extends ElkLiteralImpl implements
		ElkDateTimeLiteral {

	protected final XMLGregorianCalendar dateTime;
	
	public ElkDateTimeLiteralImpl(String lexicalForm, XMLGregorianCalendar dt) {
		super(lexicalForm);
		dateTime = dt;
	}
