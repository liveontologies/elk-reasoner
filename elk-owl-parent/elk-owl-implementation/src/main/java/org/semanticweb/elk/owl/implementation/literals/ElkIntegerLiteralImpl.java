 ...
 */
public class ElkIntegerLiteralImpl extends ElkRealLiteralImpl implements ElkIntegerLiteral {

	public ElkIntegerLiteralImpl(String lexicalForm, BigInteger num) {
	...
	public BigInteger getNumber() {
		return (BigInteger) super.getNumber();
	}
