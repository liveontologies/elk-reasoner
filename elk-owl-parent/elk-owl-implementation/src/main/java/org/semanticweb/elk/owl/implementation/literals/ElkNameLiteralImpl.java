 ...
 */
public class ElkNameLiteralImpl extends ElkTokenLiteralImpl implements
		ElkNameLiteral {

	
	public ElkNameLiteralImpl(String lexicalForm) {
		super(lexicalForm);
	}
	...
	@Override
	public NameDatatype getDatatype() {
		return ElkDatatypeMap.XSD_NAME;
	}
