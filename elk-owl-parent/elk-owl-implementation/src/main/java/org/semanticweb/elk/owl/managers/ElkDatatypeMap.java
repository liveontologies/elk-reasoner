...
public class ElkDatatypeMap {
	...
	/*private static final EnumMap<PredefinedElkIri, LiteralDatatype> map =
		new EnumMap<PredefinedElkIri, LiteralDatatype>(PredefinedElkIri.class);
	...
	public static LiteralDatatype get(ElkIri iri) {
		PredefinedElkIri preDefIri = PredefinedElkIri.lookup(iri);
		if (preDefIri != null) {
			return map.get(preDefIri);
		} else {
