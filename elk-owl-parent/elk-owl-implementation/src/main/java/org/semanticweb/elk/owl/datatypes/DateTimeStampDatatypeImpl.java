 ...
 */
public class DateTimeStampDatatypeImpl extends ElkDatatypeImpl implements DateTimeStampDatatype {

	public DateTimeStampDatatypeImpl() {
		super(PredefinedElkIri.XSD_DATE_TIME_STAMP.get());
	}
