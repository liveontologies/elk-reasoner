 ...
 */
public class PlainLiteralDatatypeImpl extends ElkDatatypeImpl implements PlainLiteralDatatype {

	public PlainLiteralDatatypeImpl() {
		super(PredefinedElkIri.RDF_PLAIN_LITERAL.get());
	}
