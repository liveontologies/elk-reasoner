 ...
 */
public class HexBinaryDatatypeImpl extends ElkDatatypeImpl implements HexBinaryDatatype {

	public HexBinaryDatatypeImpl() {
		super(PredefinedElkIri.XSD_HEX_BINARY.get());
	}
