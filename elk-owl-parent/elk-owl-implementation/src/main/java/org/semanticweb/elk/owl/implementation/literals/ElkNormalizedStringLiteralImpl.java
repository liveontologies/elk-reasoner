 ...
 */
public class ElkNormalizedStringLiteralImpl extends ElkStringLiteralImpl
		implements ElkNormalizedStringLiteral {

	
	public ElkNormalizedStringLiteralImpl(String lexicalForm) {
		super(lexicalForm);
	}
	...
	@Override
	public NormalizedStringDatatype getDatatype() {
		return ElkDatatypeMap.XSD_NORMALIZED_STRING;
	}
