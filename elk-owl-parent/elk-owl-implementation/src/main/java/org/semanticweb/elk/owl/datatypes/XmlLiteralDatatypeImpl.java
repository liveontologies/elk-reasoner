 ...
 */
public class XmlLiteralDatatypeImpl extends ElkDatatypeImpl implements XmlLiteralDatatype {

	public XmlLiteralDatatypeImpl() {
		super(PredefinedElkIri.RDF_XMLITERAL.get());
	}
