...
/**
 * For plain literals without language tags. This class uses less memory than
 * the more generic {@link ElkPlainLiteralImpl}.
 * 
 * @author Pavel Klinov
 * 
 *         pavel.klinov@uni-ulm.de
 */
public class ElkSimpleLiteralImpl extends ElkLiteralImpl implements
		ElkPlainLiteral {

	public ElkSimpleLiteralImpl(String lexicalForm) {
		super(lexicalForm);
	}
