 ...
 */
public class NonNegativeIntegerDatatypeImpl extends IntegerDatatypeImpl implements NonNegativeIntegerDatatype {

	public NonNegativeIntegerDatatypeImpl(ElkIri iri) {
		super(iri);
	}
