 ...
 */
public class NonNegativeIntegerDatatypeImpl extends ElkDatatypeImpl implements NonNegativeIntegerDatatype {

	public NonNegativeIntegerDatatypeImpl() {
		super(PredefinedElkIri.XSD_NON_NEGATIVE_INTEGER.get());
	}
