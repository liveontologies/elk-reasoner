 ...
 */
public class ElkDateTimeStampLiteralImpl extends ElkDateTimeLiteralImpl
		implements ElkDateTimeStampLiteral {

	public ElkDateTimeStampLiteralImpl(String lexicalForm, XMLGregorianCalendar dt) {
		super(lexicalForm, dt);
	}
