...
public class ElkDataPropertyAssertionAxiomImpl extends
	...
	private static final int constructorHash_ = "ElkDataPropertyAssertionAxiom"
			.hashCode();
	...
	public boolean structuralEquals(Object object) {
		if (this == object) {
			return true;
		} else if (object instanceof ElkDataPropertyAssertionAxiom) {
			return dataPropertyExpression
					.equals(((ElkDataPropertyAssertionAxiom) object)
							.getDataPropertyExpression())
					&& individual
							.equals(((ElkDataPropertyAssertionAxiom) object)
									.getIndividual())
					&& literal.equals(((ElkDataPropertyAssertionAxiom) object)
							.getLiteral());
		} else {
			return false;
		}
