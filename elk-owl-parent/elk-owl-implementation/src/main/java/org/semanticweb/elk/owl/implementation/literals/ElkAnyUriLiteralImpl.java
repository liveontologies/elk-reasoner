 ...
 */
public class ElkAnyUriLiteralImpl extends ElkLiteralImpl implements
		ElkAnyUriLiteral {

	private final URI uri_;
	
	public ElkAnyUriLiteralImpl(String lexicalForm, URI uri) {
		super(lexicalForm);
		uri_ = uri;
	}
	...
	@Override
	public AnyUriDatatype getDatatype() {
		return ElkDatatypeMap.XSD_ANY_URI;
	}
